      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProjects.map((project, index) => (
            <div key={index} className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-sm hover:shadow-lg transition-all duration-300 group border border-gray-100 dark:border-gray-800 hover:border-custom-green-200 dark:hover:border-custom-green-800">
              <div className="h-48 bg-custom-green-100 dark:bg-custom-green-900/30 flex items-center justify-center">
                <div className="text-custom-green-600 dark:text-custom-green-400 text-center">
